...
void init(Local<Object> exports) {
	...
	//OBS_API
	NODE_SET_METHOD(exports, "OBS_API_initOBS_API", OBS_API::Initialize);
	NODE_SET_METHOD(exports, "OBS_API_destroyOBS_API", OBS_API::Finalize);
	NODE_SET_METHOD(exports, "OBS_API_openAllModules", OBS_API::LoadPlugins);
	NODE_SET_METHOD(exports, "OBS_API_initAllModules", OBS_API::IntializePlugins);
	NODE_SET_METHOD(exports, "OBS_API_getPerformanceStatistics", OBS_API::GetPerformanceStatistics);
	NODE_SET_METHOD(exports, "OBS_API_getPathConfigDirectory", OBS_API::GetConfigurationDirectory);
	NODE_SET_METHOD(exports, "OBS_API_setPathConfigDirectory", OBS_API::SetConfigurationDirectory);
	NODE_SET_METHOD(exports, "OBS_API_getOBS_existingProfiles", OBS_API::GetOBSStudioProfiles);
	NODE_SET_METHOD(exports, "OBS_API_getOBS_existingSceneCollections", OBS_API::GetOBSStudioSceneCollections);
	...
	NODE_SET_METHOD(exports, "OBS_API_isOBS_installed", OBS_API::IsOBSStudioInstalled);
	...
	//OBS_settings
	NODE_SET_METHOD(exports, "OBS_settings_getGeneralSettings", OBS_settings::OBS_settings_getGeneralSettings);
	NODE_SET_METHOD(exports, "OBS_settings_saveGeneralSettings", OBS_settings::OBS_settings_saveGeneralSettings);

	NODE_SET_METHOD(exports, "OBS_settings_getStreamSettings", OBS_settings::OBS_settings_getStreamSettings);
	NODE_SET_METHOD(exports, "OBS_settings_saveStreamSettings", OBS_settings::OBS_settings_saveStreamSettings);
	NODE_SET_METHOD(exports, "OBS_settings_getStreamTypesForStreamSettings", OBS_settings::OBS_settings_getStreamTypesForStreamSettings);
	NODE_SET_METHOD(exports, "OBS_settings_setStreamTypeForStreamSettings", OBS_settings::OBS_settings_setStreamTypeForStreamSettings);

	NODE_SET_METHOD(exports, "OBS_settings_getOutputSimpleStreamingSettings", OBS_settings::OBS_settings_getOutputSimpleStreamingSettings);
	NODE_SET_METHOD(exports, "OBS_settings_saveOutputSimpleStreamingSettings", OBS_settings::OBS_settings_saveOutputSimpleStreamingSettings);
	NODE_SET_METHOD(exports, "OBS_settings_getOutputSimpleRecordingSettings", OBS_settings::OBS_settings_getOutputSimpleRecordingSettings);
	NODE_SET_METHOD(exports, "OBS_settings_saveOutputSimpleRecordingSettings", OBS_settings::OBS_settings_saveOutputSimpleRecordingSettings);
	NODE_SET_METHOD(exports, "OBS_settings_getOutputAdvancedStreamingSettings", OBS_settings::OBS_settings_getOutputAdvancedStreamingSettings);
	NODE_SET_METHOD(exports, "OBS_settings_saveOutputAdvancedStreamingSettings", OBS_settings::OBS_settings_saveOutputAdvancedStreamingSettings);
	NODE_SET_METHOD(exports, "OBS_settings_getOutputAdvancedRecordingSettings", OBS_settings::OBS_settings_getOutputAdvancedRecordingSettings);
	NODE_SET_METHOD(exports, "OBS_settings_saveOutputAdvancedRecordingSettings", OBS_settings::OBS_settings_saveOutputAdvancedRecordingSettings);
	NODE_SET_METHOD(exports, "OBS_settings_getOutputAdvancedAudioSettings", OBS_settings::OBS_settings_getOutputAdvancedAudioSettings);
	NODE_SET_METHOD(exports, "OBS_settings_saveOutputAdvancedAudioSettings", OBS_settings::OBS_settings_saveOutputAdvancedAudioSettings);
	NODE_SET_METHOD(exports, "OBS_settings_getAudioSettings", OBS_settings::OBS_settings_getAudioSettings);
	NODE_SET_METHOD(exports, "OBS_settings_saveAudioSettings", OBS_settings::OBS_settings_saveAudioSettings);
	NODE_SET_METHOD(exports, "OBS_settings_getVideoSettings", OBS_settings::OBS_settings_getVideoSettings);
	NODE_SET_METHOD(exports, "OBS_settings_saveVideoSettings", OBS_settings::OBS_settings_saveVideoSettings);
	NODE_SET_METHOD(exports, "OBS_settings_getHotkeysSettings", OBS_settings::OBS_settings_getHotkeysSettings);
	NODE_SET_METHOD(exports, "OBS_settings_saveHotkeysSettings", OBS_settings::OBS_settings_saveHotkeysSettings);
	NODE_SET_METHOD(exports, "OBS_settings_getAdvancedSettings", OBS_settings::OBS_settings_getAdvancedSettings);
	NODE_SET_METHOD(exports, "OBS_settings_saveAdvancedSettings", OBS_settings::OBS_settings_saveAdvancedSettings);
	...
	//OBS_settings unit tests
	NODE_SET_METHOD(exports, "OBS_settings_test_getGeneralSettings", OBS_settings::OBS_settings_test_getGeneralSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_saveGeneralSettings", OBS_settings::OBS_settings_test_saveGeneralSettings);

	NODE_SET_METHOD(exports, "OBS_settings_test_getStreamSettings", OBS_settings::OBS_settings_test_getStreamSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_saveStreamSettings", OBS_settings::OBS_settings_test_saveStreamSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_getStreamTypesForStreamSettings", OBS_settings::OBS_settings_test_getStreamTypesForStreamSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_setStreamTypeForStreamSettings", OBS_settings::OBS_settings_test_setStreamTypeForStreamSettings);

	NODE_SET_METHOD(exports, "OBS_settings_test_getOutputSimpleStreamingSettings", OBS_settings::OBS_settings_test_getOutputSimpleStreamingSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_saveOutputSimpleStreamingSettings", OBS_settings::OBS_settings_test_saveOutputSimpleStreamingSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_getOutputSimpleRecordingSettings", OBS_settings::OBS_settings_test_getOutputSimpleRecordingSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_saveOutputSimpleRecordingSettings", OBS_settings::OBS_settings_test_saveOutputSimpleRecordingSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_getOutputAdvancedStreamingSettings", OBS_settings::OBS_settings_test_getOutputAdvancedStreamingSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_saveOutputAdvancedStreamingSettings", OBS_settings::OBS_settings_test_saveOutputAdvancedStreamingSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_getOutputAdvancedRecordingSettings", OBS_settings::OBS_settings_test_getOutputAdvancedRecordingSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_saveOutputAdvancedRecordingSettings", OBS_settings::OBS_settings_test_saveOutputAdvancedRecordingSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_getOutputAdvancedAudioSettings", OBS_settings::OBS_settings_test_getOutputAdvancedAudioSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_saveOutputAdvancedAudioSettings", OBS_settings::OBS_settings_test_saveOutputAdvancedAudioSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_getAudioSettings", OBS_settings::OBS_settings_test_getAudioSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_saveAudioSettings", OBS_settings::OBS_settings_test_saveAudioSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_getVideoSettings", OBS_settings::OBS_settings_test_getVideoSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_saveVideoSettings", OBS_settings::OBS_settings_test_saveVideoSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_getHotkeysSettings", OBS_settings::OBS_settings_test_getHotkeysSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_saveHotkeysSettings", OBS_settings::OBS_settings_test_saveHotkeysSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_getAdvancedSettings", OBS_settings::OBS_settings_test_getAdvancedSettings);
	NODE_SET_METHOD(exports, "OBS_settings_test_saveAdvancedSettings", OBS_settings::OBS_settings_test_saveAdvancedSettings);
}
