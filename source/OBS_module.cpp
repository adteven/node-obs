...
void init(Local<Object> exports) {
    ...
    NODE_SET_METHOD(exports, "OBS_API_initAllModules", OBS_API::OBS_API_initAllModules);
    ...
    NODE_SET_METHOD(exports, "OBS_API_test_initAllModules", OBS_API::OBS_API_test_initAllModules);
